...
class ExportarActividadesController2 extends Controller
{
    public function export(Request $request)
    {
        ...
        if (!empty($data['propio']) && $data['propio'] === '1') {
            ...
            // Filtrar por nombres de pertenencia
        ...
        // Aplicar filtro por jerarquía de roles SOLO si no es propio
        if (empty($data['propio']) || $data['propio'] !== '1') {
