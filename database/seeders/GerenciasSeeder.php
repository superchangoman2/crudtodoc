...
class GerenciasSeeder extends Seeder
{
    public function run(): void
    {
        $gerencias = [
            ...
            // II. Coordinación General de Desarrollo Institucional y Proyectos Especiales
            ...
            // IX. Unidad de Género e Inclusión
            'Gerencia de Inclusión y No Discriminación',
        ];

        foreach ($gerencias as $nombre) {
            Gerencia::firstOrCreate(['nombre' => $nombre]);
        }
    }
}
